...
argument-hint: 'list | revise {spec} | [product idea]'
---
**Argument:** $ARGUMENTS
...
Use an interactive prompt to resolve each ambiguity before proceeding to review. For each unclear item:
...
2. If suggestion is clear: an interactive prompt with "Accept", "Reject", "Modify"
3. If alternatives exist: an interactive prompt with the options
...
**Use&#32;an interactive prompt** with options:
