...
| `/test <run\|write> [scope]` | Runs lint, type check, and tests. `write`: generates tests first. Auto-detects ESLint/Biome/Ruff/Clippy, TypeScript/mypy, and test runners. Sets up missing tools. |
