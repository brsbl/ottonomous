...
const INTERFACE = {
  spec: {
    display_name: "Spec",
    short_description: "Write a product spec through a collaborative interview with research",
    default_prompt:
      "Use $spec to write a product specification for this idea through a collaborative interview.",
  },
  task: {
    display_name: "Task Breakdown",
    short_description: "Break a spec into atomic, prioritized, parallelizable tasks",
    default_prompt: "Use $task to break this spec into atomic tasks grouped into work sessions.",
  },
  next: {
    display_name: "Implement Next",
    short_description: "Pick up and implement the next pending task or session",
    default_prompt: "Use $next to plan and implement the next pending task or session.",
  },
  test: {
    display_name: "Test",
    short_description: "Lint, type check, run tests, and visually verify changes",
    default_prompt: "Use $test to lint, type check, and run the tests for these changes.",
  },
  review: {
    display_name: "Code Review",
    short_description: "Multi-agent code review with P0-P2 prioritized findings",
    default_prompt: "Use $review to run a multi-agent code review of the current changes.",
  },
  summary: {
    display_name: "Change Summary",
    short_description: "Synthesize changes into a user-facing HTML summary",
    default_prompt: "Use $summary to generate a semantic HTML summary of the current changes.",
  },
  otto: {
    display_name: "Otto Autopilot",
    short_description: "Autonomously build an idea end-to-end: spec, tasks, implement, verify",
    default_prompt: "Use $otto to autonomously build this idea end-to-end.",
  },
  reset: {
    display_name: "Reset Workspace",
    short_description: "Clear .otto workflow artifacts (specs, tasks, sessions)",
    default_prompt: "Use $reset to clear the .otto workflow artifacts.",
  },
};

// Files/dirs never copied into the Codex package.
const EXCLUDE = new Set(["node_modules", "__tests__", ".DS_Store", ".git"]);
...
function main() {
  ...
  console.log(`Built Codex package for ${skills.length} skills: ${skills.join(", ")}`);
}
